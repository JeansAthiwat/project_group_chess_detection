`timescale 1ns / 1ps
    ...
    // code x68 (้)
        ...
        11'h681: data = 8'b00000011;	//         
        11'h682: data = 8'b00000110;	//         
        11'h683: data = 8'b11101110;	//         
        11'h684: data = 8'b10111100;	//         
        11'h685: data = 8'b11110000;	//         
        11'h686: data = 8'b01100000;	//         
    ...
    // code x6a (่)
        11'h6a0: data = 8'b00011000;	// ********
        11'h6a1: data = 8'b00011000;	// ********
        11'h6a2: data = 8'b00011000;	// ********
        11'h6a3: data = 8'b00011000;	// ********
        11'h6a4: data = 8'b00011000;	// ********
        11'h6a5: data = 8'b00011000;	// ********
    ...
    // code x6e (ื)
        ...
        11'h6e2: data = 8'b00010100;
        11'h6e3: data = 8'b00010100;
        11'h6e4: data = 8'b00111100;
        11'h6e5: data = 8'b01000010;
        11'h6e6: data = 8'b01111110;
    ...
    // code x75 (ี)
        ...
        11'h752: data = 8'b00000010;
        11'h753: data = 8'b00000010;
        11'h754: data = 8'b00111100;
        11'h755: data = 8'b01000010;
        11'h756: data = 8'b01111110;
    ...
    // code x79 (ั)
        ...
        11'h792: data = 8'b11100001;	//         
        11'h793: data = 8'b10100011;	//         
        11'h794: data = 8'b11111111;	//         
        11'h795: data = 8'b01011100;	//         
    ...
    // code x48 (็)
        ...
        11'h482: data = 8'b00000010;
        11'h483: data = 8'b00000010;
        11'h484: data = 8'b00000010;
        11'h485: data = 8'b00111100;
        11'h486: data = 8'b01100110;
        11'h487: data = 8'b01010010;
        11'h488: data = 8'b01110110;
        11'h489: data = 8'b01101100;
    ...
    // code x4e (์)
        11'h4e0: data = 8'b00000010;	//         
        11'h4e1: data = 8'b00000110;	//         
        11'h4e2: data = 8'b00001100;	//         
        11'h4e3: data = 8'b00011000;	//         
        11'h4e4: data = 8'b00110000;	//         
        11'h4e5: data = 8'b01101000;	//         
        11'h4e6: data = 8'b11100000;	//         
        11'h4e7: data = 8'b10100000;	//         
        11'h4e8: data = 8'b11100000;	//         
    ...
    // code x55 (๊)
        ...
        11'h553: data = 8'b00000001;
        11'h554: data = 8'b00000001;
        11'h555: data = 8'b00110111;
        11'h556: data = 8'b01001011;
        11'h557: data = 8'b01110011;
        11'h558: data = 8'b01110011;
        11'h559: data = 8'b00110010;
    ...
    // code x59 (ํ)
        ...
        11'h594: data = 8'b00011000;	// ********
        11'h595: data = 8'b00100100;	// ********
        11'h596: data = 8'b00100100;	// ********
        11'h597: data = 8'b11000011;	// ********
        11'h598: data = 8'b01000010;	// ********
        11'h599: data = 8'b00100100;	// ********
    ...
    // code x36 (ุ)
        ...
        11'h369: data = 8'b00010000;
        11'h36a: data = 8'b00101000;
        11'h36b: data = 8'b00011000;
        11'h36c: data = 8'b00001000;
        11'h36d: data = 8'b00001000;
    ...
    // code x37 (ึ)
        ...
        11'h374: data = 8'b00111110;
        11'h375: data = 8'b01000010;
        11'h376: data = 8'b01111110;
    ...
    // code x5e (ู)
        ...
        11'h5e9: data = 8'b00010010;
        11'h5ea: data = 8'b00101010;
        11'h5eb: data = 8'b00011010;
        11'h5ec: data = 8'b00001010;
        11'h5ed: data = 8'b00001010;
        11'h5ee: data = 8'b00000100;
